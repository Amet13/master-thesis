...
Не существует единого стандарта безопасности облачных вычислений, поэтому многие вендоры и облачные провайдеры придумывают свои собственные стандарты используемые внутри корпорации.
...
Существуем множество различных коммерческих и некоммерческих консорциумов которые создают различные стандарты, методические указания, среди которых наиболее известными являются Cloud Security Alliance, Национальный институт стандартов и технологий, OASIS, Open Data Center Alliance и IETF.

## 6 слайд – Стратегически важные области безопасности

Cloud Security Alliance разработало руководство по безопасности, которое покрывает аспекты и дает рекомендации потребителям облачных сред.
...
Также важную роль играет принятие Федерального закона от 21 июля 2014 г. №242-ФЗ "О внесении изменений в отдельные законодательные акты Российской Федерации в части уточнения порядка обработки персональных
